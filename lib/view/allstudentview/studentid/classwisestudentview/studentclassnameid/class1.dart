...
class Class1studentview extends StatefulWidget {
  const Class1studentview({super.key});

  

  @override
  State<Class1studentview> createState() => _IdcartdataState();
}


class _IdcartdataState extends State<Class1studentview> {
 ...
 @override
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: const Text("Class 1 Students Details"),),
    body: ListView(
      shrinkWrap: true,
      children: [
         SizedBox(
  ...
  Stream<List<StudentsModel>> readuser( String? sesson){
      ...
      return  firestore.collection("student").doc(sesson!.isEmpty?"_1":sesson).collection(sesson.isEmpty?"_1":sesson).doc("students").collection("Class_1").snapshots()
