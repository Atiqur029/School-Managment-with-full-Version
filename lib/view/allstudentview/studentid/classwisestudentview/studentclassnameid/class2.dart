...
class Class2studentidview extends StatefulWidget {
  const Class2studentidview({super.key});

  @override
  State<Class2studentidview> createState() => _Class2studentidState();
}

class _Class2studentidState extends State<Class2studentidview> {
 ...
 @override
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: const Text("Class 2 Students Details"),),
    body: ListView(
      shrinkWrap: true,
      children: [
         SizedBox(
