...
class Class9Studentview  extends StatefulWidget {
  const Class9Studentview ({super.key});

  @override
  State<Class9Studentview > createState() => _Class9StudentState();
}

class _Class9StudentState extends State<Class9Studentview > {
 ...
 @override
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: const Text("Class 9 Students Details"),),
    body: ListView(
      shrinkWrap: true,
      children: [
         SizedBox(
