...
class Class3tudentview extends StatefulWidget {
  const Class3tudentview({super.key});

  @override
  State<Class3tudentview> createState() => _Class3tudentState();
}

class _Class3tudentState extends State<Class3tudentview> {
 ...
 @override
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: const Text("Class 3 Students Details"),),
    body: ListView(
      shrinkWrap: true,
      children: [
         SizedBox(
