...
class Class6Studentview extends StatefulWidget {
  const Class6Studentview({super.key});

  @override
  State<Class6Studentview> createState() => _Class6StudentState();
}

class _Class6StudentState extends State<Class6Studentview> {
 ...
 @override
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: const Text("Class 6 Students Details"),),
    body: ListView(
      shrinkWrap: true,
      children: [
         SizedBox(
  ...
  Stream<List<StudentsModel>> readuser( String? sesson){
      ...
      return  firestore.collection("student").doc(sesson!.isEmpty?"_1":sesson).collection(sesson.isEmpty?"_1":sesson).doc("students").collection("Class_6").snapshots()
