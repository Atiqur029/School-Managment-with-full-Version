...
class Class10Studentview  extends StatefulWidget {
  const Class10Studentview ({super.key});

  @override
  State<Class10Studentview > createState() => _Class10StudentState();
}

class _Class10StudentState extends State<Class10Studentview > {
 ...
 @override
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: const Text("Class 10 Students Details"),),
    body: ListView(
      shrinkWrap: true,
      children: [
         SizedBox(
