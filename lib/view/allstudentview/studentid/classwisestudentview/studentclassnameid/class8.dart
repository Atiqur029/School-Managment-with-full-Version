...
class Class8Studentview  extends StatefulWidget {
  const Class8Studentview ({super.key});

  @override
  State<Class8Studentview > createState() => _Class8StudentState();
}

class _Class8StudentState extends State<Class8Studentview > {
 ...
 @override
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: const Text("Class 8 Students Details"),),
    body: ListView(
      shrinkWrap: true,
      children: [
         SizedBox(
