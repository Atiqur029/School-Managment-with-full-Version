...
class Class5Studentstudentview extends StatefulWidget {
  const Class5Studentstudentview({super.key});

  @override
  State<Class5Studentstudentview> createState() => _Class5StudentState();
}

class _Class5StudentState extends State<Class5Studentstudentview> {
 ...
 @override
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: const Text("Class 5 Students Details"),),
    body: ListView(
      shrinkWrap: true,
      children: [
         SizedBox(
