...
class Class4studentview extends StatefulWidget {
  const Class4studentview({super.key});

  @override
  State<Class4studentview> createState() => _Class4State();
}

class _Class4State extends State<Class4studentview> {
 ...
 @override
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: const Text("Class 4 Students Details"),),
    body: ListView(
      shrinkWrap: true,
      children: [
         SizedBox(
