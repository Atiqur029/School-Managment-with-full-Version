...
class RoutineviewerAllViwer extends StatefulWidget {
  final String classname;
  const RoutineviewerAllViwer({super.key,  required this.classname});

  @override
  State<RoutineviewerAllViwer> createState() => _RoutineviewState();
}



class _RoutineviewState extends State<RoutineviewerAllViwer> {
                ...
                return  Container(
                  ...
                  child:  ListTile(
                    ...
                    title: Padding(
                      ...
                      child: Text(" Teacher Name:${schedulelist.sirname!}",style: const TextStyle(color: Colors.orange,fontSize: 13,fontWeight: FontWeight.bold),textAlign: TextAlign.center,),
                    ),
                    subtitle: Column(
                      children: [
        ...
        activeIcon: Icons.menu,
         ...
         children: [
          SpeedDialChild(
            ...
            onTap: () {
              gotonextscreen(context, const RoutineviewerAllViwer(classname: "Class1",));
            },
          ...
          SpeedDialChild(
            ...
            child: const Icon(Icons.class_outlined,color: Colors.white,),
            onTap: () {
              gotonextscreen(context, const RoutineviewerAllViwer(classname: "Class2",));
            },
          ...
          SpeedDialChild(
            ...
            child: const Icon(Icons.class_outlined,color: Colors.white,),
            onTap: () {
              gotonextscreen(context, const RoutineviewerAllViwer(classname: "Class3",));
            },
          ...
          SpeedDialChild(
            ...
            child: const Icon(Icons.class_outlined,color: Colors.white,),
            onTap: () {
              gotonextscreen(context, const RoutineviewerAllViwer(classname: "Class4",));
            },
          ...
          SpeedDialChild(
            ...
            child: const Icon(Icons.class_outlined,color: Colors.white,),
            onTap: () {
              gotonextscreen(context, const RoutineviewerAllViwer(classname: "Class5",));
            },
          ...
          SpeedDialChild(
            ...
            child: const Icon(Icons.class_outlined,color: Colors.white,),
            onTap: () {
              gotonextscreen(context, const RoutineviewerAllViwer(classname: "Class6",));
            },
          ...
          SpeedDialChild(
            ...
            child: const Icon(Icons.class_outlined,color: Colors.white,),
            onTap: () {
              gotonextscreen(context, const RoutineviewerAllViwer(classname: "Class7",));
            },
          ...
          SpeedDialChild(
            ...
            child: const Icon(Icons.class_outlined,color: Colors.white,),
            onTap: () {
              gotonextscreen(context, const RoutineviewerAllViwer(classname: "Class8",));
            },
          ...
          SpeedDialChild(
            ...
            child: const Icon(Icons.class_outlined,color: Colors.white,),
            onTap: () {
              gotonextscreen(context, const RoutineviewerAllViwer(classname: "Class9",));
            },
          ...
          SpeedDialChild(
            ...
            child: const Icon(Icons.class_outlined,color: Colors.white,),
            onTap: () {
              gotonextscreen(context, const RoutineviewerAllViwer(classname: "Class10",));
            },
