...
class AttendenseviewforAllViewer extends StatefulWidget {
   final String classname;

   final String docname;
   const AttendenseviewforAllViewer({super.key, required this.classname, required this.docname});

  @override
  State<AttendenseviewforAllViewer> createState() => _AttendenseviewforAllViewerState();
}

class _AttendenseviewforAllViewerState extends State<AttendenseviewforAllViewer> {
  ...
  String docnames=widget.docname;
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Attendence Class Wise"),centerTitle: true,),
           ...
           SizedBox(height: 10.h,),
                ...
                SizedBox(height: 10.h,),
                 SizedBox(
                  height: 800.h,
                  child: StreamBuilder(
          stream: getdata(classname: classname,docnames: docnames,session: sessionvalue.isEmpty?"_1":sessionvalue),
        ...
        activeIcon: Icons.menu,
         ...
         children: [
          ...
          SpeedDialChild(
            ...
            child: const Icon(Icons.class_outlined,color: Colors.white,),
            onTap: () {
               gotonextscreen(context, const AttendenseviewforAllViewer(classname: "Class_2",docname: "Class_2",));
            }
          ...
          SpeedDialChild(
            ...
            child: const Icon(Icons.class_outlined,color: Colors.white,),
            onTap: () {
              gotonextscreen(context, const AttendenseviewforAllViewer(classname: "Class_3",docname: "Class_3",));
            },
          ...
          SpeedDialChild(
            ...
            child: const Icon(Icons.class_outlined,color: Colors.white,),
            onTap: () {
              gotonextscreen(context, const AttendenseviewforAllViewer(classname: "Class_4",docname: "Class_4",));
            },
          ...
          SpeedDialChild(
            ...
            child: const Icon(Icons.class_outlined,color: Colors.white,),
            onTap: () {
               gotonextscreen(context, const AttendenseviewforAllViewer(classname: "Class_5",docname: "Class_5",));
            },
          ...
          SpeedDialChild(
            ...
            child: const Icon(Icons.class_outlined,color: Colors.white,),
            onTap: () {
              gotonextscreen(context, const AttendenseviewforAllViewer(classname: "Class_6",docname: "Class_6",));
            },
          ...
          SpeedDialChild(
            ...
            child: const Icon(Icons.class_outlined,color: Colors.white,),
            onTap: () {
              gotonextscreen(context, const AttendenseviewforAllViewer(classname: "Class_7",docname: "Class_7",));
            },
          ...
          SpeedDialChild(
            ...
            child: const Icon(Icons.class_outlined,color: Colors.white,),
            onTap: () {
              gotonextscreen(context, const AttendenseviewforAllViewer(classname: "Class_8",docname: "Class_8",));
            },
          ...
          SpeedDialChild(
            ...
            child: const Icon(Icons.class_outlined,color: Colors.white,),
            onTap: () {
              gotonextscreen(context, const AttendenseviewforAllViewer(classname: "Class_9",docname: "Class_9",));
            },
          ...
          SpeedDialChild(
            ...
            child: const Icon(Icons.class_outlined,color: Colors.white,),
            onTap: () {
              gotonextscreen(context, const AttendenseviewforAllViewer(classname: "Class_10",docname: "Class_10",));
            },
  ...
  firestore.collection("Attendence").doc(session).collection(session).doc(classname).collection(classname).snapshots()
  .map((event) => event.docs.map((e) => AttendenceModel.fromMap(e)).toList());
  

  //Stream<List<AttendenceModel>>getdata({required classname ,required docnames})=>firestore.collection("Attendence").doc(docnames).collection(classname).snapshots().map((event) => event.docs.map((e) => AttendenceModel.fromMap(e)).toList());
}