...
class Class6Student extends StatefulWidget {
  const Class6Student({super.key});

  @override
  State<Class6Student> createState() => _Class6StudentState();
}

class _Class6StudentState extends State<Class6Student> {
 ...
 @override
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(title: const Text("Class 6 Session and id"),),
    body: ListView(
