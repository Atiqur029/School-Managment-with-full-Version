...
class Class2studentid extends StatefulWidget {
  const Class2studentid({super.key});

  @override
  State<Class2studentid> createState() => _Class2studentidState();
}

class _Class2studentidState extends State<Class2studentid> {
 ...
 @override
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(title: const Text("Class 2 Session and id"),),
    body: ListView(
  ...
  Stream<List<StudentsModel>> readuser( String? sesson){
      ...
      return  firestore.collection("student").doc(sesson!.isEmpty?"_1":sesson).collection(sesson.isEmpty?"_1":sesson).doc("students").collection("Class_2").snapshots()
