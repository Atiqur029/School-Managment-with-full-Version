...
class Class3tudent extends StatefulWidget {
  const Class3tudent({super.key});

  @override
  State<Class3tudent> createState() => _Class3tudentState();
}

class _Class3tudentState extends State<Class3tudent> {
 ...
 @override
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(title: const Text("Class 3 Session and id"),),
    body: ListView(
  ...
  Stream<List<StudentsModel>> readuser( String? sesson){
      ...
      return  firestore.collection("student").doc(sesson!.isEmpty?"_1":sesson).collection(sesson.isEmpty?"_1":sesson).doc("students").collection("Class_3").snapshots()
