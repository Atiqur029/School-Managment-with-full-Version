...
class Class9Student extends StatefulWidget {
  const Class9Student({super.key});

  @override
  State<Class9Student> createState() => _Class9StudentState();
}

class _Class9StudentState extends State<Class9Student> {
 ...
 @override
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(title: const Text("Class 9 Session and id"),),
    body: ListView(
  ...
  Stream<List<StudentsModel>> readuser( String? sesson){
      ...
      return  firestore.collection("student").doc(sesson!.isEmpty?"_1":sesson).collection(sesson.isEmpty?"_1":sesson).doc("students").collection("Class_9").snapshots()
