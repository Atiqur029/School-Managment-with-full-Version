...
class Class5Student extends StatefulWidget {
  const Class5Student({super.key});

  @override
  State<Class5Student> createState() => _Class5StudentState();
}

class _Class5StudentState extends State<Class5Student> {
 ...
 @override
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(title: const Text("Class 5 Session and id"),),
    body: ListView(
                  ...
                  showDialog(context: context, builder: ((context) {
                    ...
                    actions: [
                      ElevatedButton(onPressed: (() {
                         ...
                         ElevatedButton(onPressed: (() {
                          database.delete(classname: "Class_5", model: studentsModel);
                          Navigator.pop(context);
  ...
  Stream<List<StudentsModel>> readuser( String? sesson){
      ...
      return  firestore.collection("student").doc(sesson!.isEmpty?"_1":sesson).collection(sesson.isEmpty?"_1":sesson).doc("students").collection("Class_5").snapshots()
