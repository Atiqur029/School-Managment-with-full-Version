...
class Class8Student extends StatefulWidget {
  const Class8Student({super.key});

  @override
  State<Class8Student> createState() => _Class8StudentState();
}

class _Class8StudentState extends State<Class8Student> {
 ...
 @override
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(title: const Text("Class 8 Session and id"),),
    body: ListView(
                  ...
                  showDialog(context: context, builder: ((context) {
                    ...
                    actions: [
                      ElevatedButton(onPressed: (() {
                         ...
                         ElevatedButton(onPressed: (() {
                          database.delete(classname: "Class_8", model: studentsModel);
                          Navigator.pop(context);
  ...
  Stream<List<StudentsModel>> readuser( String? sesson){
      ...
      return  firestore.collection("student").doc(sesson!.isEmpty?"_1":sesson).collection(sesson.isEmpty?"_1":sesson).doc("students").collection("Class_8").snapshots()
