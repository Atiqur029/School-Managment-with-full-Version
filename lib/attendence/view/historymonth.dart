...
class HistoryMonth extends StatefulWidget {
  ...
  const HistoryMonth({super.key, required this.classes,required this.monthdoc});
...
@override
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar:AppBar(title:  Text("Month History of Attend Student for $classname",style: const TextStyle(fontSize: 14,fontWeight: FontWeight.bold,color: Colors.white),),leading: IconButton(onPressed: () {
        ...
        activeIcon: Icons.menu,
         ...
         children: [
          SpeedDialChild(
            ...
            onTap: () {
              gotonextscreen(context,  const HistoryMonth(classes: "Class_1",monthdoc: "abc",));
            },
